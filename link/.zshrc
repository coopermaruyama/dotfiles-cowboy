...
plugins=(git cloudapp coffee colored-man common-aliases gem git-extras git-flow git-hubflow git-prompt osx meteor heroku github git-remote-branch rbenv rsync rvm sublime sudo theme web-search z zsh_reload)
# # User configuration
#
